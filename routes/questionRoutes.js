...
const {getAllQuestions,  getQuestionById, searchByKeyword, adminAddQuestion,adminEditQuestion, adminDeleteQuestion} = require("../controllers/questionController")
...
// GET route to get a question by id api/questions/:id
